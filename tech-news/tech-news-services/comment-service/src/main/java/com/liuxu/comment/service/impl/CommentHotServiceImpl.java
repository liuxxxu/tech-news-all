...
import com.liuxu.comment.service.CommentHotService;
...
public class CommentHotServiceImpl implements CommentHotService {
    ...
    public void hotCommentExecutor(AppComment apComment) {
        ...
        List<AppComment> hotCommentList = mongoTemplate.find(query, AppComment.class);
        ...
        AppComment lastComment = hotCommentList.stream()
                .sorted(Comparator.comparing(AppComment::getLikes).reversed())
...
//            最后的评论改为普通评论
    ...
    public ResponseResult findByArticleId(CommentDTO dto) {
        ...
        //   ========================需要变更处 start =============================
        //2 查询Mongo文章所有评论列表
        List<AppComment> apCommentList = null;
        ...
        return ResponseResult.successResult(apCommentList);
    }
}
