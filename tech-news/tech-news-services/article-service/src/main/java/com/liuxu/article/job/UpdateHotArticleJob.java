...
//        }
        aggBehaviorDTOList.forEach(hotArticleService::updateAppArticle);
...
//        4. 封装返回结果
            ...
            CustException.throwException(AppHttpCodeEnum.SERVER_ERROR, e.getMessage());
        }
